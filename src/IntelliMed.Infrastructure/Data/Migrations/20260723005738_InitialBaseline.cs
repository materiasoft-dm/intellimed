        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicareNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    MedicarePosition = table.Column<string>(type: "TEXT", nullable: true),
                    PensionNumber = table.Column<string>(type: "TEXT", nullable: true),
                    DvaNumber = table.Column<string>(type: "TEXT", nullable: true),
                    HealthFundName = table.Column<string>(type: "TEXT", nullable: true),
                    HealthFundNumber = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    AhpraNumber = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "TEXT", nullable: true),
                    IsBulkBill = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Practitioners_ProviderNumber",
                table: "Practitioners",
