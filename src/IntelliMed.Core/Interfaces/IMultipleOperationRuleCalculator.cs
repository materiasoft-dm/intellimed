...
/// than something IBillingCalculator can resolve one line at a time. WorkCover QLD runs a
/// materially different split-pool version of the rule (see MultipleOperationRuleCalculator),
/// hence the account type parameter.
/// </summary>
public interface IMultipleOperationRuleCalculator
{
    Task ApplyMultipleOperationRuleAsync(ICollection<InvoiceItem> items, AccountTypeEnum accountType);
}
